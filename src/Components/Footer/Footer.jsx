        ...
        <div className=" rounded mt-4 ">
            <footer className="bg-gray-800 text-white ">
                <div className="md:flex md:justify-between md:items-center sm:px-12  px-4 bg-[#ffffff19] py-8  ">
                    ...
                    <div>
                        <input type="text" placeholder="Enter Your Address" className=" sm:w-72 w-full sm:mr-5 mr-1 lg:mb-0 mb-4 py-2 rounded-sm px-2  focus:outline-none focus:border-blue-500 text-gray-600 " />
